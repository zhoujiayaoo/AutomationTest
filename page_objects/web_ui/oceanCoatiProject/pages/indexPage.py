...
from page_objects.web_ui.oceanCoatiProject.elements.indexPageElements import IndexPageElements
from page_objects.web_ui.oceanCoatiProject.pages.searchPage import SearchPage
class IndexPage:
